...
class TestDatabaseToFile(unittest.TestCase):
    ...
    def setUp(self):
        self.test_sql_handle = mysqlconnectionhandler()
        self.test_sql_handle.username = 'anonymous'
        self.test_sql_handle.username = 'anonymous'
        self.test_sql_handle.database = 'Actino_Draft'
    ...
    def test_retrieve_seqrecord_from_database_1(self):
        ...
        self.assertEqual(test_seqrecord_list[0].name, "Trixie")
        self.assertEqual(test_seqrecord_list[1].name, "Alice")
        self.assertEqual(test_seqrecord_list[2].name, "D29")
    ...
    def test_retrieve_database_version_1(self):
        ...
        assertEqual(len(test_version_data), 2)

    def test_seqfeature_file_output_1(self):
        database_to_file.seqfeature_file_output\
                (self.test_seq_record_list, self.test_format, os.getcwd())
