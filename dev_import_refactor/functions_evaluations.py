...
def evaluate_genome(genome_object):

    #Evaluate every CDS feature
    for cds_feature in genome_object.cds_features:
        evaluate_cds(cds_feature)

    #Evaluate every tRNA feature
    for trna_feature in genome_object.trna_features:
        evaluate_trna(trna_feature)


    #Evaluate every genome
    #TODO = run all genome object methods




def evaluate_cds(cds_feature):

    # TODO = run all CDS object methods

    pass


def evaluate_trna(trna_feature):

    # TODO = run all tRNA object methods
...
#TODO complete this function.
def compare_ticket_to_phamerator(matched_object):
