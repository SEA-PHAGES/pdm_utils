...
Required only if gene phamilies need to be identified using MMseqs2 in the 'phamerate' pipeline.

MMseqs2 is a suite of tools for rapid searching and clustering of protein and nucleotide sequences (:ref:`Steinegger and Söding, 2017 <bibliography>`). Detailed instructions are provided by the developers and can be found on the project's :mmseqs2:`GitHub page <>`.

The following instructions provide an example of how it can be installed on your local MacOS or Ubuntu machine.
